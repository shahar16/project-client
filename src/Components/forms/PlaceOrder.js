          ...
          return (
            <Form>
              ...
              <Row>
                <Col md="8">
                  <div className="form-group row">
                    <label htmlFor="placeOrder-street" className="col-sm-4 col-form-label">Street</label>
                    <div className="col-sm-8">
                      <Field type="text" name="street" className="form-control"
                             id="placeOrder-street"/>
                ...
                <Col md="4">
                  <div className="form-group row">
                    <label htmlFor="placeOrder-num" className="col-sm-3 col-form-label">Num</label>
                    <div className="col-sm-9">
                      <Field min="1" type="number" name="houseNum" className="form-control" id="placeOrder-num"/>
